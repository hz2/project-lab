...
const proxyList: IProxy[] = [
    ...
    {
        origin: "github.com/VSCodium/vscodium/releases/download/",
        host: "github",
        list: [
            {
                target: "mirrors.tuna.tsinghua.edu.cn/github-release/VSCodium/vscodium/",
                host: 'cloudflare',
            }
        ]
    },
...
const softwareList = [
    ...
    },
    {
        ...
        list: [
            ...
            {
                name: 'codium',
                link: "https://mirrors.tuna.tsinghua.edu.cn/github-release/VSCodium/vscodium/LatestRelease/",
                icon: 'codium.svg',
            },
            {
                name: 'dbeaver',
